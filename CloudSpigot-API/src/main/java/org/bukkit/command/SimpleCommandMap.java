...
import eu.minewars.cloudspigot.command.CloudSpigotCommand;
import eu.minewars.cloudspigot.command.UpdateCommand;
...
public class SimpleCommandMap implements CommandMap {
	...
	private void setDefaultCommands() {
		...
		register("cloudspigot", new UpdateCommand("update")); // CloudSpigot
	...
	public void registerServerAliases() {
		...
		for (Map.Entry<String, String[]> entry : values.entrySet()) {
			...
			if (targets.size() > 0) {
				knownCommands.put(alias.toLowerCase(java.util.Locale.ENGLISH), new FormattedCommandAlias(
						alias.toLowerCase(java.util.Locale.ENGLISH), targets.toArray(new String[targets.size()])));
			} else {
