...
public abstract class EntityHuman extends EntityLiving {
	...
	public void n() {
        ...
        this.aR = this.bT;
        if (this.isSprinting()) {
            this.aR = (float) (this.aR + this.bT * 0.3D);
        }
        ...
        if (entity.bd()) {
            if (!entity.t(this)) {
                ...
                if (f > 0.0F || f1 > 0.0F) {
                    ...
                    if (flag && !flag2 && !flag1 && this.onGround && d0 < this.cy()) {
    ...
    public void a(boolean flag, boolean flag1, boolean flag2) {
        ...
        if (this.bedPosition != null && iblockdata.getBlock() == Blocks.BED) {
            this.world.setTypeAndData(this.bedPosition, iblockdata.set(BlockBed.OCCUPIED, false), 4);
